...
public:
	...
	void Init ();
	/**
	 * \brief Configure the links between the nodes according to the type of channel we want to deploy over the scenario (i.e. simple error rate-based model, BER-based formulae, Hidden Markov Process or
	 * BEAR wireless channel)
	 */
	void SetChannel ();
	/**
	...
	/**
	 * \param propTracing Copies the object used to trace the simulation
	 */
